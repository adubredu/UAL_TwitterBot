...
class Bot:
        ...
        def __init__(self):
               ...
               #This array contains all the keywords to be searched for 
                #in incoming tweets
                self.KEYWORD = ['water policy', 'urban heat island', 
                'water resource planning', 'community-based', 
                'urban watersheds', 'environmental management', 
                'social-ecological', 'resilience', 'sustainable commons', 
                'water supply', 'rural water supply', 
                'sustainability', 'water use', 'heat islands', 'water quality']

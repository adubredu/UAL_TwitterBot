...
class Bot:
        ...
        def __init__(self):
                ...
                #in incoming tweets
                self.KEYWORD = ['housing', 'housing subsidies', 
                'neighborhood revitalization', 'low income housing tax credits', 
                'fair housing', 'sustainable housing', 
                'mixed-income housing', 'housing development', 
                'public housing', 'HOPE VI', 'inclusionary zoning', 
                'housing policy', 'public housing authorities', 
                'federal housing policy', 'housing choice vouchers', 
                'low income housing tax credits', 'real estate', 
                'equity planning', 'housing finance', 
                'state housing policy', 'section 8 housing']
                ...
                self.follow_count = 0;
                self.CONSUMER_KEY = 'wb9BMFOxUmHzN3Xr1H8a7jYpS'
                self.CONSUMER_KEY_SECRET = 'LlUncYu0OmAQKNIRLEmZwGdQSNCAoNqmNbodzwWTtp0O2Vukcc'
                self.ACCESS_TOKEN = '1056528382320631808-QfGfK4EKDgvsUcMllZYcGoLTZ3oNNC'
                self.ACCESS_TOKEN_SECRET = 'MPePZglCtiU7UgCaE9o7yHwJTTn65Yhv5oo18fG9N6ThP'
...
class Bot:
        ...
        def __init__(self):
                ...
                #This array contains all the keywords to be searched for 
                #in incoming tweets
                self.KEYWORD = ["housing", 'housing subsidies', 'neighborhood revitalization', 'low income housing tax credits', 
                'fair housing', 'sustainable housing,' 'mixed-income housing', 'housing development', 'public housing', 
                'HOPE VI', 'inclusionary zoning', 'housing policy', 'public housing authorities', 'federal housing policy', 
                'housing choice vouchers', 'low income housing tax credits', 'real estate', 'equity planning', 'housing finance', 
                'state housing policy', 'section 8 housing']

...
class Bot:
        ...
        def __init__(self):
                ...
                #in incoming tweets
                self.KEYWORD = ['active transportation', 'bicycling', 
                'walking', 'walk to school', 'safe routes to school', 
                'transportation equity', 'walkability', 'nonmotorized modes', 
                'bicycle infrastructure', 'transportation policy', 'bicycle planning', 
                'cycling', 'walk', 'bicycle', 'pedestrian safety', 'bicycle safety', 
                'travel behavior', 'walkscore', 'walkable', 'walkable neighborhood', 
                'pedestrian', 'mode shift', 'transportation demand management']
                

                #This array contains responses to accepted tweets that contain 
                # keyword(s) in both the KEYWORD array and the GREET_QUERY
                #array.
                self.GREETING = ["Really?!"
                                    "Not sure about this…"
                                    "Unconvincing"
                                    "Not quite"
                                    ...
                                    "Not enough"
                                    "Overthinking it"
                                    "Oversimplification of a complex idea"
                                    "Not clear enough"
                                    "Didn't enjoy it"
                                    "I don't agree"
                                    ...
                                    "#disapointing"
                                    "#NotQuite"
                                    "Maybe if approached from a different angle…"
                                    "#SinkNotSwim"
                                    "#SurfaceNotSubstance"
                                    "Needs to be brought to life"
                                    "Missing something but can't quite figure out what"
                                    "Confusing"
                                    "Convoluted"
                                    "Too complicated"
                                    "Wish it wasn't so hard to understand"
                                    "Not quite sure what this is trying to do"
                                    "#fail"
                                    ...
                                    "Kind of repetitive, don’t you think?"
                                    "Missed the target"
                                    "Nothing really new"
                                    "Simplified just a bit too much"
                                    "#nicetry"
]
                ...
                self.follow_count = 0;
                self.CONSUMER_KEY = 'k2GFlFrQJFdiqrWlNg3MQ45oI' 
                self.CONSUMER_KEY_SECRET = 'qgYMuK0LbEH1W1DdcUI2VrcHCh3REsJIKeWJOlu3NANJPK11we'  
                self.ACCESS_TOKEN = '1054005745107255297-Y1ARJmVbcbztoiF6qzo6LfdXCTwS7f'
                self.ACCESS_TOKEN_SECRET = 'KLnkHAf5AZEXfAgWUnxjzvrickFkwvpCJ25USk4AYktI9'
